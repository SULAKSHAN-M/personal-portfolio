          ...
          <div className="flex h-16 items-center">
            ...
            <div className="flex-shrink-0">
              <Link to="/" className="flex items-center space-x-3">
                ...
                <span className="text-xl font-bold text-white">Sulakshan</span>
              </Link>
            </div>
            ...
            <div className="hidden md:flex flex-shrink-0 items-center space-x-1 ml-auto lg:ml-0">
              ...
              <button
                onClick={toggleTheme}
                className="p-2 ml-1 text-gray-400 hover:text-white transition-colors rounded-lg hover:bg-white/[0.05]"
