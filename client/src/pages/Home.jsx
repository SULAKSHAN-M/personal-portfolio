...
const GITHUB_API = `https://api.github.com/users/${import.meta.env.VITE_GITHUB_USERNAME || "SULAKSHAN-M"}`;
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 mt-12 sm:mt-8 md:mt-10 lg:mt-12">
      <div className="text-center relative z-10 max-w-4xl mx-auto">
        <motion.h1
          className="text-4xl sm:text-6xl md:text-8xl font-bold mb-4 sm:mb-7 relative tracking-tighter"
        ...
        >
          Software Engineering undergraduate specializing in Full Stack
          Development, with hands-on experience in Cloud technologies and
        ...
        >
          ...
          <span className="text-xs text-gray-500 -mt-2">
            Resume last updated Sep 16, 2026
          </span>
        ...
        >
          ...
          >
            <div className="p-3 rounded-xl transition-colors mb-2 w-full max-w-[200px]">
              <Award className="w-5 h-5 sm:w-6 sm:h-6 text-gray-400 group-hover:text-white transition-colors mx-auto" />
            </div>
